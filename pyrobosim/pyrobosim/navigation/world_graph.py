...
import time
import itertools
from typing import Optional, TYPE_CHECKING, Union, Any, List
...
class WorldGraphPlannerPolygon:
    ...
    def reset(self) -> None:
        ...
        for entity in itertools.chain(
            self.world.rooms, self.world.hallways, self.world.locations  # type: ignore
        ):
...
class WorldGraphPlanner(PathPlannerBase):
    ...
    def __init__(self, **planner_config: Any) -> None:
        ...
        if planner_config.get("grid", None):
            ...
            self.impl = WorldGraphPlannerPolygon(**planner_config)  # type: ignore
